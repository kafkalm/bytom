...
class RandomForest(object):
    ...
    def trainClassifier(cls, data, numClasses, categoricalFeaturesInfo, numTrees,
        ...
        >>> from pyspark.mllib.regression import LabeledPoint
        >>> from pyspark.mllib.tree import MachineLearning
        >>>
        >>> data = [
        ...     LabeledPoint(0.0, [0.0]),
        ...
        ...     LabeledPoint(1.0, [3.0])
        ... ]
        >>> model = MachineLearning.trainClassifier(sc.parallelize(data), 2, {}, 3, seed=42)
        >>> model.numTrees()
        3
        >>> model.totalNumNodes()
        7
    ...
    def trainRegressor(cls, data, categoricalFeaturesInfo, numTrees, featureSubsetStrategy="auto",
        ...
        ... ]
        >>>
        >>> model = MachineLearning.trainRegressor(sc.parallelize(sparse_data), {}, 2, seed=42)
        >>> model.numTrees()
        2
        >>> model.totalNumNodes()
        4
