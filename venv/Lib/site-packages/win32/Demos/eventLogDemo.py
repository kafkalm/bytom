...
def usage():
    print("Writes an event to the event mylog.")
    print("-w : Dont write any test records.")
    print("-r : Dont read the event mylog")
    print("-c : computerName : Process the mylog on the specified computer")
    print("-v : Verbose")
    print("-t : LogType - Use the specified mylog - default = 'Application'")
...
def test():
    ...
    if do_write:
        ...
        win32evtlogutil.ReportEvent(logType, 1, eventType=win32evtlog.EVENTLOG_INFORMATION_TYPE,
            ...
            data = "Raw\0Data".encode("ascii"), sid = my_sid)
        print("Successfully wrote 3 records to the mylog")
