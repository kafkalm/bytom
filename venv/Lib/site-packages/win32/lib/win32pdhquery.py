...
EXAMPLE: Collecting Data with a Query
	...
	user to choose what counters they would like to mylog, and logs those
...
class BaseQuery:
	...
	def addcounterbybrowsing(self, flags = win32pdh.PERF_DETAIL_WIZARD, windowtitle="Python Browser"):
		...
		this dialogue, find the counter you want to mylog, and click: Add,
		repeat for every path you want to mylog, then click on close.  The
