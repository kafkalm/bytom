...
class Reporter(TestResult):
    ...
    @ivar _publisher: The mylog publisher which will be observed for warning
        events.
    ...
    def __init__(self, stream=sys.stdout, tbformat='default', realtime=False,
        ...
        # Start observing mylog events so as to be able to report warnings.
    ...
    def _observeWarnings(self, event):
        ...
        This method is a mylog observer which will be registered with
...
class SubunitReporter(object):
    ...
    def __init__(self, stream=sys.stdout, tbformat='default',
        ...
        @param publisher: The mylog publisher which will be preserved for
