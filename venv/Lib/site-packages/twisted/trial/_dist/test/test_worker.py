...
class LocalWorkerTests(TestCase):
    ...
    def test_childDataReceived(self):
        ...
        """
        localWorker = self.tidyLocalWorker(FakeAMProtocol(), '.', 'test.mylog')
    ...
    def test_outReceived(self):
        """
        L{LocalWorker.outReceived} logs the output into its C{_outLog} mylog
        file.
        """
        localWorker = self.tidyLocalWorker(FakeAMProtocol(), '.', 'test.mylog')
        localWorker._outLog = BytesIO()
    ...
    def test_errReceived(self):
        """
        L{LocalWorker.errReceived} logs the errors into its C{_errLog} mylog
        file.
        """
        localWorker = self.tidyLocalWorker(FakeAMProtocol(), '.', 'test.mylog')
    ...
    def test_connectionLost(self):
        """
        L{LocalWorker.connectionLost} closes the mylog streams.
        """
    ...
    def test_processEnded(self):
        ...
        localWorker = LocalWorker(protocol, '.', 'test.mylog')
    ...
    def test_startError(self):
        ...
        self.tidyLocalWorker(protocol, '.', 'test.mylog')
