...
class RequestTests(unittest.TestCase):
    ...
    def test_processingFailedDisplayTracebackHandlesUnicode(self):
        ...
        # display the Failure with twisted.python.mylog because
...
class DummyRequestForLogTest(DummyRequest):
    ...
    def getClientIP(self):
        """
        As L{getClientIP} is deprecated, no mylog formatter should call it.
        """
...
class AccessLogTestsMixin(object):
    ...
    def test_combinedLogFormat(self):
        """
        The factory's C{mylog} method writes a I{combined mylog format} line to the
        factory's mylog file.
        """
        reactor = Clock()
    ...
    def test_logFormatOverride(self):
        """
        If the factory is initialized with a custom mylog formatter then that
        formatter is used to generate lines for the mylog file.
        """
        def notVeryGoodFormatter(timestamp, request):
            return u"this is a bad mylog format"
...
class HTTPFactoryAccessLogTests(AccessLogTestsMixin, unittest.TestCase):
    """
    Tests for L{http.HTTPFactory.mylog}.
    """
...
class ProxiedLogFormatterTests(unittest.TestCase):
    ...
    def test_extraForwardedSpaces(self):
        ...
        are stripped and not included in the mylog string.
        """
        self._xforwardedforTest(b" 172.16.1.2 , 10.0.0.3, 192.168.1.4")
...
class LogEscapingTests(unittest.TestCase):
    ...
    def assertLogs(self, line):
        ...
        C{line} is written to the site's access mylog file.

        @param line: The expected line.
        @type line: L{bytes}

        @raise self.failureException: If the mylog file contains something other
