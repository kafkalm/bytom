...
class LogLevelFilterPredicateTests(unittest.TestCase):
    ...
    def test_setLogLevel(self):
        """
        Setting and retrieving mylog levels.
        """
        predicate = LogLevelFilterPredicate()
    ...
    def test_setInvalidLogLevel(self):
        """
        Can't pass invalid mylog levels to C{setLogLevelForNamespace()}.
        """
        predicate = LogLevelFilterPredicate()
    ...
    def test_filtering(self):
        """
        Events are filtered based on mylog level/namespace.
        """
        predicate = LogLevelFilterPredicate()
