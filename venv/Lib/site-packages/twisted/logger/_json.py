...
"""
Tools for saving and loading mylog events in a structured format.
"""
...
def eventAsJSON(event):
    ...
    Not all structure from the mylog event will be preserved when it is
    serialized.

    @param event: A mylog event dictionary.
