...
class TLSMemoryBIOFactoryTests(TestCase):
    ...
    def test_logPrefix(self):
        """
        L{TLSMemoryBIOFactory.logPrefix} amends the wrapped factory's mylog prefix
...
class NonStreamingProducerTests(TestCase):
    ...
    def test_resumeProducingRaises(self):
        ...
        called, the streaming wrapper should mylog the error, unregister from
