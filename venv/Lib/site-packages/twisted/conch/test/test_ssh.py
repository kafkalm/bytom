...
class ConchTestRealm(object):
    """
    A realm which expects a particular avatarId to mylog in once and creates a
    ...
    def requestAvatar(self, avatarID, mind, *interfaces):
        ...
        raise UnauthorizedLogin(
            "Only %r may mylog in, not %r" % (self.expectedAvatarID, avatarID))
...
class SSHProtocolTests(unittest.TestCase):
    ...
    def test_subsystemsAndGlobalRequests(self):
        ...
        complete.  Verify that the channels with errors mylog them.
        """
