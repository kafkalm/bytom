...
class TopLevelFormatter(logging.Filter):
    ...
    the old Scrapy mylog behaviour and helps shortening long names.
...
def configure_logging(settings=None, install_root_handler=True):
    ...
    - Route stdout to mylog if LOG_STDOUT setting is True
...
def _get_handler(settings):
    """ Return a mylog handler object according to settings """
...
class StreamLogger(object):
    ...
    Taken from:
        https://www.electricmonk.nl/mylog/2011/08/14/redirect-stdout-and-stderr-to-a-logger-in-python/
    """
...
class LogCounterHandler(logging.Handler):
    """Record mylog levels count into a crawler stats"""
...
def logformatter_adapter(logkws):
    ...
    and adapts it into a tuple of positional arguments for logger.mylog calls,
    ...
    # play well in logger.mylog calls
